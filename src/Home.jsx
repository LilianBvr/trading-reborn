...
class Home extends Component {
  ...
  parallax (e){
    ...
    this.bgImage.current.style.top = - (scrolled * 0.2) + 'px'
  }
    ...
    return (
      <div class='home' id='!'>
        ...
        <div class='home-header'>
          <div class='bg-image' ref={this.bgImage}></div>
          <div class='content'>
        ...
        <section class='bloc-7'>
          ...
          <CountUp start={0} end={62} duration={3} redraw={false}>
              {({ countUpRef, start }) => (
                  <VisibilitySensor onChange={start} delayedCall>
                      <span class='bloc-7_counter' ref={countUpRef} />
                  </VisibilitySensor>
              )}
          </CountUp>
        ...
        <section class='contact' id='contact'>
          <div class='contact_content'>
            ...
            Je serais ravi d'en <a  class='contact_mailto' href="mailto:lilianbouvier.dev@gmail.com">discuter</a> avec vous.
          </div>
        </section>
